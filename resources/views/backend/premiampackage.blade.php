    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        <div>
            ...
            <p class="breadcrumbs"><span><a href="{{ route('dashboard') }}">Dashboard</a></span>
                <span><i class="mdi mdi-chevron-right"></i></span>Premium Package
            </p>
        </div>
        <div>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#addclient"> Add Premium Package
            </button>
        </div>
    </div>
                        ...
                        <table id="responsive-data-table" class="table">
                            ...
                            <tbody>
                                @foreach ($packages as $package)
                                        ...
                                        <td>
                                            <div class="btn-group mb-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editclient{{ $package->id }}">
                                                        Edit
                                                    </button>
                                    ...
                                    <div class="modal fade modal-add-contact" id="editclient{{ $package->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('package.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-header px-4">
                                                        <h5 class="modal-title" id="exampleModalCenterTitle">Edit Premium Package</h5>
                                                    </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $package->name }}">
                                                                    @error('name')
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="discount_price" class="form-control @error('discount_price') is-invalid @enderror" name="discount_price" value="{{ $package->discount_price }}">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="price" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $package->price }}">
                                                                    @error('price')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="validity" class="form-control @error('validity') is-invalid @enderror" name="validity" value="{{ $package->validity }}">
                                                                    @error('validity')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" id="interested" class="form-control @error('interested') is-invalid @enderror" name="interested" value="{{ $package->interested }}">
                                                                    @error('interested')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </div>
