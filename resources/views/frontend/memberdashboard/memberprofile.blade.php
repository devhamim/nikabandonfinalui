                                    ...
                                    <div style="border: 1px solid #dcdcdc; position: relative;">
                                        ...
                                        <div class="photo-mask-detail-page" ng-class="{'show-photo-mask-label': userProfile.PhotoMaskLabel!==''}" style="display: none;">
                                            ...
                                            <div class="photo-request-link">
                                                <div>gg</div>
                                                <div style="margin-top:5px;"><a href="{{ route('premium.package') }}" target="_blank">View Plans</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="shadow" style="background-color: #fff;">
                                    ...
                                    <div style="background-color: #dcdcdc; border: 1px solid #ccc; padding: 10px; padding-bottom: 16px; ">
                                        ...
                                        <form action="{{ route('interest.store') }}" method="post">
                                            ...
                                            <button type="submit" name="action" value="message" class="bm-button detail-page-action-btn" style="margin-left:7px; background-color: #c0272c;">
                                                <i class="icon-mail"></i>Send Message
                                            </button>
                                            <button type="submit" name="action" value="interested" class="bm-button detail-page-action-btn" style="margin-left:7px; background-color: #c0272c;">
                                                <i class="icon-thumbs-up-1"></i>I am Interested
                                            </button>
                                            <button type="submit" name="action" value="favorite" class="bm-button detail-page-action-btn" style="margin-left:7px; background-color: #c0272c;">
                                                    ...
                                                    <ul class="clearfix">
                                                        ...
                                                        <li id="liEducationDetails">
                                                            ...
                                                            <p class="pt2 pr20">
                                                                ...
                                                                <span class="lockView">
                                                                    <img alt="feature lock" src="{{ asset('frontend') }}/images/icon_lock_description.png" /> <a href="{{ route('premium.package') }}">Upgrade membership to view details</a>
                                                                </span>
                                                                @endif
                                                                @if(Auth::guard('customer')->user()->pay_active  == 1)
                                                        ...
                                                        <li id="liProfessionalDetails">
                                                            ...
                                                            <p class="pt2 pr20">
                                                                @if(Auth::guard('customer')->user()->pay_active  == 0)
                                                                <span class="lockView">
                                                                    <img alt="Upgrade membership to view details" src="{{ asset('frontend') }}/images/icon_lock_description.png" /> <a href="{{ route('premium.package') }}">Upgrade membership to view details</a>
                                                                </span>
                                                                @endif
                                                                @if(Auth::guard('customer')->user()->pay_active  == 1)
                                                                <span class="unlockView">
