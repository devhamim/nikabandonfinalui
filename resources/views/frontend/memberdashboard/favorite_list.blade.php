                                ...
                                <div class="form-horizontal">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div>
                                                <br />
                                                <table id="data-table-favorite-list" class="table table-striped table-bordered table-hover" style="width: 100%;">
                                                    <tr>
                                                        <th>Name</th>
                                                        <th>Date</th>
                                                        <th>Action</th>
                                                    ...
                                                    <tr>
                                                        <td>{{ $favorite->rel_to_customer->name }}</td>
                                                        <td>{{ $favorite->created_at->format('d m Y') }}</td>
                                                        <td><a href="{{ route('favorite.list.delete', $favorite->id) }}" class="btn btn-danger">Delete</a></td>
                                                    </tr>
                                                    @endforeach
                                                </table>
                                            </div>
