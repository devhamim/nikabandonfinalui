        ...
        <div class="main-content" style="padding-bottom: 30px;">
            <div class="main-content-inner">
                <div class="page-content">
                    ...
                    <form action="{{ route('partner.preferences.update') }}" method="POST" style="border: 1px solid #dcdcdc; background-color: #fff; padding-top: 30px; border-top: 0;">
                                ...
                                <div class="col-md-9">
                                    <div id="login-section">
                                        <div class="row form-group partner-gender">
                                            ...
                                            <div class="col-sm-9">
                                                <label>
                                                    ...
                                                    <input type="radio" name="partner_gender" class="form-check-input" id="male" value="male" style="position: relative; left: -6px; top: 2px;" >
                                                    Male
                                                </label>
                                                <label class="padd-left-10" style="padding-left: 20px;">
                                                    <i class="icon-female" style="color: deeppink; font-size: 20px;"></i>
                                                    <input type="radio" name="partner_gender" class="form-check-input" id="female" value="female" style="position: relative; left: -6px; top: 2px;" >
                                                    Female
                                                </label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="age_from" style="float:left; width: 110px;" class="form-select form-control" >
                                                ...
                                                <select name="age_to" style="float:left; width: 105px;" class="form-select form-control" >
